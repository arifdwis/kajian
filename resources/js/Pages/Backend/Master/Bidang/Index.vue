...
<template>
 <Head title="Master Bidang Kajian" />
 ...
 <tr v-if="bidangs.data.length === 0">
 <td colspan="3" class="px-6 py-8 text-center text-gray-400">
 Tidak ada data bidang kajian ditemukan.
 </td>
 </tr>
 <tr v-for="item in bidangs.data" :key="item.id" class="hover:bg-gray-50/50 dark:hover:bg-gray-800 transition-colors">
 ...
 <button 
 @click="confirmDeleteBidang(item.id)"
 ...
 Menampilkan {{ bidangs.from || 0 }} sampai {{ bidangs.to || 0 }} dari {{ bidangs.total }} data
 </p>
 <Pagination :links="bidangs.links" />
 </div>
 </div>
 ...
 {{ isEdit ? 'Edit Bidang Kajian' : 'Tambah Bidang Kajian' }}
 </h4>
 ...
 <div>
 <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Nama Bidang <span class="text-red-500">*</span></label>
 <input 
 type="text" 
 v-model="form.nama"
 required
