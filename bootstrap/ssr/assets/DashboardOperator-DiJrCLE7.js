          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "space-y-8" }, [
                createVNode("div", { class: "relative overflow-hidden from-purple-700 via-indigo-700 to-indigo-800 rounded-card p-8 text-white shadow-purple-500/10" }, [
                  ...
                  createVNode("div", { class: "relative z-10 max-w-xl" }, [
                    createVNode("span", { class: "bg-paper/10 text-white font-bold text-xs uppercase tracking-wider px-3 py-1 rounded-full border border-white/20" }, " Operator Bidang "),
                    createVNode("h2", { class: "text-3xl font-semibold mt-4" }, "Selamat Datang, " + toDisplayString(user.value.name), 1),
                    createVNode("p", { class: "text-purple-100/90 text-sm mt-2 leading-relaxed" }, " Kelola draf, usulan kajian baru, lampiran, dan publikasi penelitian khusus untuk Bidang Anda. ")
                  ])
                ]),
