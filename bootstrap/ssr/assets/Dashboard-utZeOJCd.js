      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="bg-paper dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-card p-6 flex flex-col justify-between"${_scopeId}><div${_scopeId}><h4 class="font-bold text-gray-800 dark:text-white text-base mb-1"${_scopeId}>Persentase Jenis Kajian</h4><p class="text-xs text-gray-400 mb-6"${_scopeId}>Berdasarkan klasifikasi riset</p></div><div class="h-72 flex items-center justify-center"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(apexchart), {
              type: "donut",
              height: "100%",
              width: "100%",
            ...
            _push2(`</div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-8"${_scopeId}><div class="lg:col-span-2 bg-paper dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-card p-6"${_scopeId}><h4 class="font-bold text-gray-800 dark:text-white text-base mb-1"${_scopeId}>Kajian per Bidang OPD</h4><p class="text-xs text-gray-400 mb-6"${_scopeId}>Jumlah publikasi terbit per unit</p><div class="h-72"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(apexchart), {
              type: "bar",
              height: "100%",
              width: "100%",
            ...
            return [
              createVNode("div", { class: "space-y-8" }, [
                createVNode("div", { class: "relative overflow-hidden rounded-card p-8 text-white" }, [
                  createVNode("div", { class: "absolute -right-10 -top-10 w-40 h-40 bg-paper/10 rounded-full blur-2xl" }),
                  createVNode("div", { class: "absolute right-20 bottom-0 w-32 h-32 bg-indigo-500/20 rounded-full blur-xl" }),
                  createVNode("div", { class: "relative z-10 max-w-xl" }, [
                    createVNode("span", { class: "bg-paper/10 text-white font-bold text-xs uppercase tracking-wider px-3 py-1 rounded-full border border-white/20" }, " Admin Bapperida "),
                    createVNode("h2", { class: "text-3xl font-semibold mt-4" }, "Selamat Datang Kembali, " + toDisplayString(user.value.name), 1),
                    createVNode("p", { class: "text-blue-100/90 text-sm mt-2 leading-relaxed" }, " Kelola data penelitian, riset, dan kajian strategis Pemerintah Kota Samarinda secara terpadu melalui panel SIKAJIAN. ")
                  ])
                ]),
                ...
                createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-3 gap-8" }, [
                  createVNode("div", { class: "lg:col-span-2 bg-paper dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-card p-6" }, [
                    createVNode("h4", { class: "font-bold text-gray-800 dark:text-white text-base mb-1" }, "Kajian per Bidang OPD"),
