        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.menus, (menu) => {
              ...
              _push2(`</div></div><div class="flex items-center gap-2"${_scopeId}><button class="p-2 bg-paper dark:bg-gray-800 border dark:border-gray-600 text-gray-600 hover:text-amber-500 rounded-sm transition-colors duration-150" title="Edit"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                icon: "solar:pen-bold",
                class: "w-4 h-4"
              }, null, _parent2, _scopeId));
                        ...
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          ...
                          createVNode("div", { class: "flex items-center gap-2" }, [
                            createVNode("button", {
                              ...
                              class: "p-2 bg-paper dark:bg-gray-800 border dark:border-gray-600 text-gray-600 hover:text-amber-500 rounded-sm transition-colors duration-150",
                              title: "Edit"
                            }, [
                              createVNode(_component_Icon, {
                                icon: "solar:pen-bold",
