...
<template>
 ...
 <Link :href="route('settings.users.index')" class="p-2.5 bg-gray-50 dark:bg-gray-700 dark:text-gray-300 hover:bg-paper-2 hover:text-blue-600 rounded-sm transition-all">
 ...
 <p class="text-xs text-gray-500 mt-0.5">Perbarui rincian otorisasi, afilliasi OPD, or password pengguna.</p>
 </div>
 </div>
 ...
 <h5 class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Ganti Password (Opsional)</h5>
 <p class="text-[10px] text-slate-400">Biarkan kosong jika tidak ingin mengubah kata sandi lama.</p>
 </div>
 <div>
