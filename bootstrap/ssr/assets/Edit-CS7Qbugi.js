import { onMounted, resolveComponent, unref, withCtx, createVNode, createTextVNode, withModifiers, withDirectives, vModelText, openBlock, createBlock, Fragment, renderList, toDisplayString, vModelSelect, createCommentVNode, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-w-xl mx-auto space-y-6"${_scopeId}><div class="flex items-center gap-3 bg-paper dark:bg-gray-800 p-6 rounded-card border border-gray-100 dark:border-gray-700"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "max-w-xl mx-auto space-y-6" }, [
                    ...
                    createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, [
                      ...
                      createVNode("div", null, [
                        ...
                        withDirectives(createVNode("select", {
                          ...
                          createVNode("option", { value: "" }, "Tanpa OPD"),
                          ...
                          [vModelSelect, unref(form).id_opd]
                        ])
                      ])
                    ]),
