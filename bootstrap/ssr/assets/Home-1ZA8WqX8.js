import { ref, resolveComponent, unref, withCtx, createTextVNode, createVNode, toDisplayString, withModifiers, withDirectives, vModelText, openBlock, createBlock, Fragment, renderList, useSSRContext } from "vue";
              ...
              createVNode("section", { style: { "background-color": "var(--color-paper)" } }, [
                createVNode("div", { class: "container mx-auto px-4 xl:px-0 pt-28 pb-24 md:pt-32 md:pb-28" }, [
                  ...
                  createVNode("div", { style: { "margin-top": "60px", "border-top": "1px solid var(--color-rule)", "border-bottom": "1px solid var(--color-rule)", "overflow": "hidden", "padding": "14px 0" } }, [
                    createVNode("div", { style: { "display": "flex", "gap": "56px", "animation": "marquee 35s linear infinite", "white-space": "nowrap", "font-family": "var(--font-mono)", "font-size": "12px", "letter-spacing": "0.1em", "color": "var(--color-ink-2)", "text-transform": "uppercase" } }, [
                      createVNode("span", null, "KAJIAN · RISET · EVALUASI · INOVASI · KEBIJAKAN"),
                      createVNode("span", null, "BAPPEDA · SAMARINDA · KALTIM · PEMBANGUNAN"),
                      createVNode("span", null, "DATA · DOKUMEN · LAPORAN · PENELITIAN"),
                      createVNode("span", null, "TRANSPARAN · TERBUKA · TERPERCAYA · PUBLIK"),
                      createVNode("span", null, "KAJIAN · RISET · EVALUASI · INOVASI · KEBIJAKAN"),
                      createVNode("span", null, "BAPPEDA · SAMARINDA · KALTIM · PEMBANGUNAN"),
                      createVNode("span", null, "DATA · DOKUMEN · LAPORAN · PENELITIAN"),
                      createVNode("span", null, "TRANSPARAN · TERBUKA · TERPERCAYA · PUBLIK")
