        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "p-2.5 rounded-sm transition-colors duration-150",
              ...
              createVNode("div", { class: "space-y-6" }, [
                ...
                createVNode("div", {
                  ...
                  createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-4 gap-4 items-end" }, [
                    ...
                    createVNode("button", {
                      onClick: resetFilter,
                      class: "text-xs font-bold py-2.5 rounded-sm transition-colors duration-150",
