                ...
                createVNode("div", { class: "container mx-auto px-4 xl:px-0 pt-20 pb-20 md:pt-28 md:pb-24" }, [
                  ...
                  createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center" }, [
                    createVNode("div", { class: "lg:col-span-3" }, [
                      ...
                      createVNode("div", { class: "mt-8" }, [
                        createVNode("form", {
                          ...
                          class: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2 p-1.5 rounded-xl border transition-colors duration-150 shadow-sm focus-within:shadow-md",
                    ...
                    createVNode("div", { class: "lg:col-span-2" }, [
                      createVNode("div", {
                        class: "p-6 rounded-card border shadow-sm transition-shadow duration-200 hover:shadow-md",
                        style: { "border-color": "var(--color-rule)", "background-color": "var(--color-paper)" }
                      }, [
                        createVNode("div", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("div", {
                            ...
                            createVNode("div", {
                              class: "h-full rounded-full transition-colors duration-150 duration-500",
                  ...
                  createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-12 gap-12 items-center" }, [
                    createVNode("div", { class: "lg:col-span-5 flex items-start justify-center gap-6 sm:gap-8" }, [
                      createVNode("div", { class: "relative group text-center" }, [
                        createVNode("div", {
                          class: "overflow-hidden rounded-2xl border shadow-sm transition-transform duration-300 group-hover:shadow-md group-hover:-translate-y-1",
              ...
              createVNode("section", {
                ...
                createVNode("div", { class: "container mx-auto px-4 xl:px-0" }, [
                  ...
                  createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-6" }, [
                    createVNode("div", {
                      class: "p-8 rounded-card border shadow-sm transition-transform duration-300 hover:-translate-y-1 hover:shadow-md",
                      style: { "border-color": "var(--color-rule)", "background-color": "var(--color-paper)" }
                    }, [
                      createVNode("div", {
