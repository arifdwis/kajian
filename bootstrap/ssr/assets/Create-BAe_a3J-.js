      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h3 class="text-xl font-bold text-gray-900 dark:text-white"${_scopeId}>Tambah Dokumen Kajian Baru</h3><p class="text-xs text-gray-500 mt-1"${_scopeId}>Langkah ${ssrInterpolate(currentStep.value)} dari ${ssrInterpolate(totalSteps)}: ${ssrInterpolate(steps[currentStep.value - 1].label)}</p></div></div></div><div class="bg-paper dark:bg-gray-800 p-4 rounded-card border border-gray-100 dark:border-gray-700"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><!--[-->`);
            ssrRenderList(steps, (step, index) => {
              ...
              _push2(`</span><span class="hidden lg:inline"${_scopeId}>${ssrInterpolate(step.label)}</span></button>`);
              if (index < steps.length - 1) {
                _push2(`<div class="${ssrRenderClass([currentStep.value > index + 1 ? "bg-green-400" : "bg-gray-200 dark:bg-gray-700", "flex-1 h-0.5 mx-2"])}"${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--]-->`);
            ...
            _push2(` Informasi Dasar </h4><div class="grid grid-cols-1 md:grid-cols-3 gap-6"${_scopeId}><div class="md:col-span-3"${_scopeId}><label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"${_scopeId}>Judul Kajian / Penelitian <span class="text-red-500"${_scopeId}>*</span></label><input type="text"${ssrRenderAttr("value", unref(form).judul)} required class="${ssrRenderClass([stepErrors.value.judul ? "border-red-400" : "", "w-full text-sm rounded-sm border border-gray-200 dark:border-gray-700 bg-paper dark:bg-gray-900 text-gray-900 dark:text-white px-4 py-2.5 focus:ring-2 focus:ring-blue-500/20"])}" placeholder="Masukkan Judul Kajian Secara Lengkap..."${_scopeId}>`);
            ...
            _push2(`</div><div${_scopeId}><label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"${_scopeId}>Tahun Kajian <span class="text-red-500"${_scopeId}>*</span></label>`);
            ...
            _push2(` Hasil &amp; Rekomendasi Kebijakan </h4><div class="space-y-5"${_scopeId}><div${_scopeId}><label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"${_scopeId}>Temuan Utama</label><textarea rows="4" class="w-full text-sm rounded-sm border border-gray-200 dark:border-gray-700 bg-paper dark:bg-gray-900 text-gray-900 dark:text-white px-4 py-2.5" placeholder="Fakta-fakta penting yang ditemukan selama riset..."${_scopeId}>${ssrInterpolate(unref(form).temuan)}</textarea></div><div${_scopeId}><label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"${_scopeId}>Rekomendasi Strategis</label><textarea rows="4" class="w-full text-sm rounded-sm border border-gray-200 dark:border-gray-700 bg-paper dark:bg-gray-900 text-gray-900 dark:text-white px-4 py-2.5" placeholder="Saran kebijakan bagi Pemerintah Kota..."${_scopeId}>${ssrInterpolate(unref(form).rekomendasi)}</textarea></div></div></div><div class="bg-paper dark:bg-gray-800 p-8 rounded-card border border-gray-100 dark:border-gray-700 space-y-6" style="${ssrRenderStyle(currentStep.value === 5 ? null : { display: "none" })}"${_scopeId}><h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-gray-700 pb-3 flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              icon: "solar:tag-bold",
              class: "w-5 h-5 text-blue-500"
            }, null, _parent2, _scopeId));
            ...
            _push2(`<!--]--></div></div></div><div class="bg-paper dark:bg-gray-800 p-8 rounded-card border border-gray-100 dark:border-gray-700 space-y-6" style="${ssrRenderStyle(currentStep.value === 6 ? null : { display: "none" })}"${_scopeId}><h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-gray-700 pb-3 flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              icon: "solar:upload-bold",
              class: "w-5 h-5 text-blue-500"
            }, null, _parent2, _scopeId));
            _push2(` Upload Berkas Riset </h4><div class="grid grid-cols-1 md:grid-cols-3 gap-6"${_scopeId}><div class="p-6 border border-dashed border-gray-200 dark:border-gray-700 rounded-card flex flex-col items-center text-center hover:border-blue-400 hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors"${_scopeId}><div class="w-14 h-14 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center mb-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              icon: "solar:gallery-bold",
              class: "w-7 h-7 text-blue-500"
            }, null, _parent2, _scopeId));
            _push2(`</div><span class="text-sm font-semibold text-gray-700 dark:text-gray-300"${_scopeId}>Gambar Cover</span><span class="text-[11px] text-gray-400 mt-1"${_scopeId}>JPG, PNG (Maks 5MB)</span><label class="mt-4 px-4 py-2 text-xs font-semibold rounded-lg border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
            ...
            if (unref(form).file_cover) {
              ...
              _push2(`<span class="text-[10px] text-gray-300 dark:text-gray-600 mt-2"${_scopeId}>Belum ada berkas</span>`);
            }
            ...
            _push2(`</div><span class="text-sm font-semibold text-gray-700 dark:text-gray-300"${_scopeId}>Dokumen Utama <span class="text-red-500"${_scopeId}>*</span></span><span class="text-[11px] text-gray-400 mt-1"${_scopeId}>PDF Only (Maks 20MB)</span><label class="mt-4 px-4 py-2 text-xs font-semibold rounded-lg border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              icon: "solar:upload-minimalistic-bold",
              class: "w-4 h-4 inline-block mr-1"
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div><span class="text-sm font-semibold text-gray-700 dark:text-gray-300"${_scopeId}>Presentasi / Slide</span><span class="text-[11px] text-gray-400 mt-1"${_scopeId}>PPT, PPTX, PDF (Maks 20MB)</span><label class="mt-4 px-4 py-2 text-xs font-semibold rounded-lg border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              icon: "solar:upload-minimalistic-bold",
              class: "w-4 h-4 inline-block mr-1"
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div></div></div><div class="flex items-center justify-between mt-6"${_scopeId}><div${_scopeId}>`);
            if (currentStep.value === 1) {
              ...
              _push2(`<button type="button" class="px-5 py-3 border border-gray-200 dark:border-gray-700 rounded-card text-sm font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                icon: "solar:arrow-left-outline",
                class: "w-4 h-4 inline-block mr-1"
              }, null, _parent2, _scopeId));
            ...
            if (currentStep.value < totalSteps) {
              _push2(`<button type="button" class="px-6 py-3 bg-blue-600 text-white font-bold rounded-card text-sm hover:bg-blue-700 transition-colors inline-flex items-center gap-1"${_scopeId}> Selanjutnya`);
              _push2(ssrRenderComponent(_component_Icon, {
              ...
              _push2(`<span${_scopeId}>Simpan Kajian</span></button>`);
            }
                ...
                createVNode("div", { class: "flex items-center justify-between bg-paper dark:bg-gray-800 p-6 rounded-card border border-gray-100 dark:border-gray-700" }, [
                  createVNode("div", { class: "flex items-center gap-3" }, [
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "text-xs text-gray-500 mt-1" }, "Langkah " + toDisplayString(currentStep.value) + " dari " + toDisplayString(totalSteps) + ": " + toDisplayString(steps[currentStep.value - 1].label), 1)
                    ])
                  ])
                ]),
                createVNode("div", { class: "bg-paper dark:bg-gray-800 p-4 rounded-card border border-gray-100 dark:border-gray-700" }, [
                    ...
                    (openBlock(), createBlock(Fragment, null, renderList(steps, (step, index) => {
                      return openBlock(), createBlock(Fragment, { key: index }, [
                        createVNode("button", {
                          ...
                          createVNode("span", { class: "hidden lg:inline" }, toDisplayString(step.label), 1)
                        ], 10, ["onClick"]),
                        index < steps.length - 1 ? (openBlock(), createBlock("div", {
                          key: 0,
                          class: ["flex-1 h-0.5 mx-2", currentStep.value > index + 1 ? "bg-green-400" : "bg-gray-200 dark:bg-gray-700"]
                  ...
                  withDirectives(createVNode("div", { class: "bg-paper dark:bg-gray-800 p-8 rounded-card border border-gray-100 dark:border-gray-700 space-y-6" }, [
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-6" }, [
                      createVNode("div", { class: "p-6 border border-dashed border-gray-200 dark:border-gray-700 rounded-card flex flex-col items-center text-center hover:border-blue-400 hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors" }, [
                        ...
                        createVNode("label", { class: "mt-4 px-4 py-2 text-xs font-semibold rounded-lg border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors" }, [
                          createVNode(_component_Icon, {
                            icon: "solar:upload-minimalistic-bold",
                            class: "w-4 h-4 inline-block mr-1"
                          }),
                      ...
                      createVNode("div", { class: "p-6 border-2 border-dashed border-red-200 dark:border-red-900/40 rounded-card flex flex-col items-center text-center hover:border-red-400 hover:bg-red-50/30 dark:hover:bg-red-900/10 transition-colors" }, [
                        ...
                        createVNode("span", { class: "text-sm font-semibold text-gray-700 dark:text-gray-300" }, [
                          createTextVNode("Dokumen Utama "),
                          createVNode("span", { class: "text-red-500" }, "*")
                        ]),
